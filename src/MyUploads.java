...
public class MyUploads {
    ...
    public static List<Video> run() {
        ...
        try {
            ...
            YouTube.Channels.List channelRequest = Main.youtube.channels().list("contentDetails");
            ...
            if (channelsList != null) {
                ...
                YouTube.PlaylistItems.List playlistItemRequest =
                        Main.youtube.playlistItems().list("id,contentDetails,snippet");
     ...
     */
    private static List<Video> prettyPrint(int size, Iterator<PlaylistItem> playlistEntries) {
        ArrayList<Video> toReturn = new ArrayList<>();
        while (playlistEntries.hasNext()) {
            PlaylistItem playlistItem = playlistEntries.next();
            Video v = new Video(playlistItem.getSnippet().getTitle(), playlistItem.getContentDetails().getVideoId());
            toReturn.add(v);
        }
        return toReturn;
    }
